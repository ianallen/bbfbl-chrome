...
exports.default = [
    ...
    {
        "name": "Jalen Green",
        "salary25_26": 33584499,
        "yahoo_id": 6513
    },
    {
        "name": "Khris Middleton",
        "salary25_26": 33296296,
        "yahoo_id": 5073
    },
    {
    ...
    {
        "name": "Julius Randle",
        "salary25_26": 30864198,
        "yahoo_id": 5318
    },
    {
        "name": "Dejounte Murray",
        "salary25_26": 30801103,
        "yahoo_id": 5660
    },
    {
    ...
    {
        "name": "Nic Claxton",
        "salary25_26": 25352272,
        "yahoo_id": 6219
    },
    {
        "name": "Myles Turner",
        "salary25_26": 25318251,
        "yahoo_id": 5471
    },
    {
        "name": "Miles Bridges",
    ...
    },
    {
        ...
        "salary25_26": 22500000,
        "yahoo_id": 6549
    },
    {
        "name": "Kyle Kuzma",
        "salary25_26": 22410605,
        "yahoo_id": 5840
    },
    {
    ...
    {
        "name": "Steven Adams",
        "salary25_26": 14130435,
        "yahoo_id": 5163
    },
    {
        "name": "Caris LeVert",
        "salary25_26": 14104000,
        "yahoo_id": 5651
    },
    {
        "name": "Damian Lillard",
...
const SELECTORS = {
    ...
    GAMES_PLAYED_CELL: 'td[data-stat="gp"]',
    TEAM_PAGE: '.team-page',
    ROSTER_TABLE: '.roster-table, .players-table',
    MAX_GAMES_TABLE: '#position-caps-roto table',
...
class Utils {
    ...
    static getHref(element) {
        const $el = $(element);
        return $el.find('a').attr('href');
    }
    static isPlayerElement(element) {
...
class SalaryRenderer {
    ...
    static renderTotalSalary(total) {
...
class SalaryTool {
    ...
    static setupAutoComplete() {
        const source = bbfbl_salaries.map(s => ({
            label: s.name,
            value: s.name,
            id: s.yahoo_id,
    ...
    static generatePlayerWrapper(label) {
    ...
    static getPlayerSalaryInfo(element) {
...
class GamesPlayedTracker {
    ...
    static calculateTotalGamesPlayed() {
        let totalGames = 0;
    ...
    static calculateProgress(totalGames) {
        ...
        return {
            ...
            isNearMax: totalGames >= MAX_TOTAL_GAMES * 0.9,
            isAtMax: totalGames >= MAX_TOTAL_GAMES
        };
    }
    static createGamesPlayedIndicator(totalGames, progress) {
...
$(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fetchSalariesFromRemote();
        setInterval(() => renderBbfbl(pageState), RENDER_INTERVAL_MS);
        function renderBbfbl(pageState) {
        ...
        function renderSalaries(pageState) {
        ...
        function renderSalaryTool(pageState) {
...
function fetchSalariesFromRemote() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield fetch(URLS.SALARIES_CSV);
        ...
        return new Promise((resolve, reject) => {
            ...
            chrome.storage.local.get([STORAGE_KEYS.SALARIES, STORAGE_KEYS.CACHE_DATE], function (result) {
                if (result[STORAGE_KEYS.SALARIES] && result[STORAGE_KEYS.CACHE_DATE] && !Utils.isExpired(result[STORAGE_KEYS.CACHE_DATE])) {
                    ...
                    bbfbl_salaries = result[STORAGE_KEYS.SALARIES];
